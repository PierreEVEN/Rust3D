    ...
    fn from(format: &PixelFormat) -> Self {
        match format {
            ...
            PixelFormat::A2R10G10B10_UNORM_PACK32 => {
                VkPixelFormat(Format::A2R10G10B10_UNORM_PACK32)
            }
            PixelFormat::A2R10G10B10_SNORM_PACK32 => {
                VkPixelFormat(Format::A2R10G10B10_SNORM_PACK32)
            }
            PixelFormat::A2R10G10B10_USCALED_PACK32 => {
                VkPixelFormat(Format::A2R10G10B10_USCALED_PACK32)
            }
            PixelFormat::A2R10G10B10_SSCALED_PACK32 => {
                VkPixelFormat(Format::A2R10G10B10_SSCALED_PACK32)
            }
            ...
            PixelFormat::A2B10G10R10_UNORM_PACK32 => {
                VkPixelFormat(Format::A2B10G10R10_UNORM_PACK32)
            }
            PixelFormat::A2B10G10R10_SNORM_PACK32 => {
                VkPixelFormat(Format::A2B10G10R10_SNORM_PACK32)
            }
            PixelFormat::A2B10G10R10_USCALED_PACK32 => {
                VkPixelFormat(Format::A2B10G10R10_USCALED_PACK32)
            }
            PixelFormat::A2B10G10R10_SSCALED_PACK32 => {
                VkPixelFormat(Format::A2B10G10R10_SSCALED_PACK32)
            }
            ...
            PixelFormat::ETC2_R8G8B8A1_UNORM_BLOCK => {
                VkPixelFormat(Format::ETC2_R8G8B8A1_UNORM_BLOCK)
            }
            PixelFormat::ETC2_R8G8B8A1_SRGB_BLOCK => {
                VkPixelFormat(Format::ETC2_R8G8B8A1_SRGB_BLOCK)
            }
            PixelFormat::ETC2_R8G8B8A8_UNORM_BLOCK => {
                VkPixelFormat(Format::ETC2_R8G8B8A8_UNORM_BLOCK)
            }
            PixelFormat::ETC2_R8G8B8A8_SRGB_BLOCK => {
                VkPixelFormat(Format::ETC2_R8G8B8A8_SRGB_BLOCK)
            }
