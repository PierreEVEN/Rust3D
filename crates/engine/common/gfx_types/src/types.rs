...
impl PixelFormat {
    pub fn type_size(&self) -> u32 {
        match &self {
            PixelFormat::UNDEFINED => {
                logger::fatal!("Cannot deduce type size for PixelFormat::{:?}", self)
            }
    ...
    pub fn components(&self) -> u8 {
        match self {
            ...
            PixelFormat::R4G4_UNORM_PACK8 => { 2 }
            PixelFormat::R4G4B4A4_UNORM_PACK16 => { 4 }
            PixelFormat::B4G4R4A4_UNORM_PACK16 => { 4 }
            PixelFormat::R5G6B5_UNORM_PACK16 => { 3 }
            PixelFormat::B5G6R5_UNORM_PACK16 => { 3 }
            PixelFormat::R5G5B5A1_UNORM_PACK16 => { 4 }
            PixelFormat::B5G5R5A1_UNORM_PACK16 => { 4 }
            PixelFormat::A1R5G5B5_UNORM_PACK16 => { 4 }
            PixelFormat::R8_UNORM => { 1 }
            PixelFormat::R8_SNORM => { 1 }
            PixelFormat::R8_USCALED => { 1 }
            PixelFormat::R8_SSCALED => { 1 }
            ...
            PixelFormat::A2B10G10R10_UINT_PACK32 => { 4 }
            PixelFormat::A2B10G10R10_SINT_PACK32 => { 4 }
            PixelFormat::R16_UNORM => { 1 }
            PixelFormat::R16_SNORM => { 1 }
            PixelFormat::R16_USCALED => { 1 }
            PixelFormat::R16_SSCALED => { 1 }
            PixelFormat::R16_UINT => { 1 }
            PixelFormat::R16_SINT => { 1 }
            PixelFormat::R16_SFLOAT => { 1 }
            PixelFormat::R16G16_UNORM => { 2 }
            PixelFormat::R16G16_SNORM => { 2 }
            PixelFormat::R16G16_USCALED => { 2 }
            PixelFormat::R16G16_SSCALED => { 2 }
            PixelFormat::R16G16_UINT => { 2 }
            PixelFormat::R16G16_SINT => { 2 }
            PixelFormat::R16G16_SFLOAT => { 2 }
            PixelFormat::R16G16B16_UNORM => { 3 }
            PixelFormat::R16G16B16_SNORM => { 3 }
            PixelFormat::R16G16B16_USCALED => { 3 }
            PixelFormat::R16G16B16_SSCALED => { 3 }
            PixelFormat::R16G16B16_UINT => { 3 }
            PixelFormat::R16G16B16_SINT => { 3 }
            PixelFormat::R16G16B16_SFLOAT => { 3 }
            PixelFormat::R16G16B16A16_UNORM => { 4 }
            PixelFormat::R16G16B16A16_SNORM => { 4 }
            PixelFormat::R16G16B16A16_USCALED => { 4 }
            PixelFormat::R16G16B16A16_SSCALED => { 4 }
            PixelFormat::R16G16B16A16_UINT => { 4 }
            PixelFormat::R16G16B16A16_SINT => { 4 }
            PixelFormat::R16G16B16A16_SFLOAT => { 4 }
            PixelFormat::R32_UINT => { 1 }
            PixelFormat::R32_SINT => { 1 }
            PixelFormat::R32_SFLOAT => { 1 }
            PixelFormat::R32G32_UINT => { 2 }
            PixelFormat::R32G32_SINT => { 2 }
            PixelFormat::R32G32_SFLOAT => { 2 }
            PixelFormat::R32G32B32_UINT => { 3 }
            PixelFormat::R32G32B32_SINT => { 3 }
            PixelFormat::R32G32B32_SFLOAT => { 3 }
            PixelFormat::R32G32B32A32_UINT => { 4 }
            PixelFormat::R32G32B32A32_SINT => { 4 }
            PixelFormat::R32G32B32A32_SFLOAT => { 4 }
            PixelFormat::R64_UINT => { 1 }
            PixelFormat::R64_SINT => { 1 }
            PixelFormat::R64_SFLOAT => { 1 }
            PixelFormat::R64G64_UINT => { 2 }
            PixelFormat::R64G64_SINT => { 2 }
            PixelFormat::R64G64_SFLOAT => { 2 }
            PixelFormat::R64G64B64_UINT => { 3 }
            PixelFormat::R64G64B64_SINT => { 3 }
            PixelFormat::R64G64B64_SFLOAT => { 3 }
            PixelFormat::R64G64B64A64_UINT => { 4 }
            PixelFormat::R64G64B64A64_SINT => { 4 }
            PixelFormat::R64G64B64A64_SFLOAT => { 4 }
            PixelFormat::B10G11R11_UFLOAT_PACK32 => { 3 }
            PixelFormat::E5B9G9R9_UFLOAT_PACK32 => { 3 }
            PixelFormat::D16_UNORM => { 1 }
            PixelFormat::X8_D24_UNORM_PACK32 => { 1 }
            PixelFormat::D32_SFLOAT => { 1 }
            PixelFormat::S8_UINT => { 1 }
            PixelFormat::D16_UNORM_S8_UINT => { 1 }
            PixelFormat::D24_UNORM_S8_UINT => { 1 }
            PixelFormat::D32_SFLOAT_S8_UINT => { 1 }
            PixelFormat::BC1_RGB_UNORM_BLOCK => { 3 }
            PixelFormat::BC1_RGB_SRGB_BLOCK => { 3 }
            PixelFormat::BC1_RGBA_UNORM_BLOCK => { 4 }
            PixelFormat::BC1_RGBA_SRGB_BLOCK => { 4 }
            PixelFormat::BC2_UNORM_BLOCK => { todo!() }
            PixelFormat::BC2_SRGB_BLOCK => { 3 }
            PixelFormat::BC3_UNORM_BLOCK => { todo!() }
            PixelFormat::BC3_SRGB_BLOCK => { 3 }
            ...
            PixelFormat::BC7_SRGB_BLOCK => { 3 }
            PixelFormat::ETC2_R8G8B8_UNORM_BLOCK => { 3 }
            PixelFormat::ETC2_R8G8B8_SRGB_BLOCK => { 3 }
            PixelFormat::ETC2_R8G8B8A1_UNORM_BLOCK => { 4 }
            PixelFormat::ETC2_R8G8B8A1_SRGB_BLOCK => { 4 }
            PixelFormat::ETC2_R8G8B8A8_UNORM_BLOCK => { 4 }
            PixelFormat::ETC2_R8G8B8A8_SRGB_BLOCK => { 4 }
            PixelFormat::EAC_R11_UNORM_BLOCK => { 1 }
            PixelFormat::EAC_R11_SNORM_BLOCK => { 1 }
            PixelFormat::EAC_R11G11_UNORM_BLOCK => { 2 }
            PixelFormat::EAC_R11G11_SNORM_BLOCK => { 2 }
            ...
            PixelFormat::ASTC_10X8_SRGB_BLOCK => { 3 }
            PixelFormat::ASTC_10X10_UNORM_BLOCK => { todo!() }
            PixelFormat::ASTC_10X10_SRGB_BLOCK => { 3 }
            PixelFormat::ASTC_12X10_UNORM_BLOCK => { todo!() }
            PixelFormat::ASTC_12X10_SRGB_BLOCK => { 3 }
            PixelFormat::ASTC_12X12_UNORM_BLOCK => { todo!() }
            PixelFormat::ASTC_12X12_SRGB_BLOCK => { 3 }
        }
    }
}
