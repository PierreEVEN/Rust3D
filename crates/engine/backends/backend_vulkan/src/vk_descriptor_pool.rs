...
impl VkDescriptorPool {
    ...
    fn create_descriptor_pool(&self) -> vk::DescriptorPool {
        let pool_sizes = vec![
            vk::DescriptorPoolSize { ty: vk::DescriptorType::SAMPLER, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::COMBINED_IMAGE_SAMPLER, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::SAMPLED_IMAGE, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::STORAGE_IMAGE, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::UNIFORM_TEXEL_BUFFER, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::STORAGE_TEXEL_BUFFER, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::UNIFORM_BUFFER, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::STORAGE_BUFFER, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::UNIFORM_BUFFER_DYNAMIC, descriptor_count: self.max_descriptor_per_type },
            vk::DescriptorPoolSize { ty: vk::DescriptorType::STORAGE_BUFFER_DYNAMIC, descriptor_count: self.max_descriptor_per_type },
